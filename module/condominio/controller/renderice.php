...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="condominio"; // Como figura en la BD
    $NombreDeModuloVista="Condominio"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='module/condominio/view/local_view.css' type='text/css' media='all'>
                    ...
                    <link rel='stylesheet' href='services/resources/pro.fontawesome.com/releases/v5.10.0/css/all.css' integrity='sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p' crossorigin='anonymous'/>  ";
    ...
    $InserFooter="  <script type='text/javascript' src='services/resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='module/condominio/view/local_view_inicio.js' type='text/javascript'></script>
                    <script src='module/condominio/view/local_view_condominio.js' type='text/javascript'></script>
                    <script src='module/condominio/view/local_view_puerta.js' type='text/javascript'></script>
                    <script src='module/condominio/view/local_view_edificio.js' type='text/javascript'></script>
