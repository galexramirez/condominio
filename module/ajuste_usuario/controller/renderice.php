...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="ajuste_usuario"; // Como figura en la BD
    $NombreDeModuloVista="Ajuste de Usuario"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='module/ajuste_usuario/view/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='services/resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='module/ajuste_usuario/view/local_view_inicio.js' type='text/javascript'></script>
                    <script src='module/ajuste_usuario/view/local_view_ajuste_usuario.js' type='text/javascript'></script>  ";
...
// 4.0 CONTRUCCION DE LA VISTA
    ...
    // VISTA DEL MODULO
    MController('ajuste_usuario','logico');
