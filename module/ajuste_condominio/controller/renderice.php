...
// 1.0 DATOS A USARSE EN EL MODULO - MODIFICAR SI SE CREA NUEVO MODULO
    $NombreDeModulo="ajuste_condominio"; // Como figura en la BD
    $NombreDeModuloVista="Ajustes Condominio"; // Como se muestra la usuario
...
// 2.0 VERIFICA PERMISOS DEL USUARIO SOBRE EL MODULO
 ...
 // 3.0 RECURSOS PARA EL MODULO     
    $InsertHead="   <link rel='stylesheet' href='module/ajuste_condominio/view/local_view.css' type='text/css' media='all'>
    ...
    $InserFooter="  <script type='text/javascript' src='services/resources/DataTables-10.25/datatables/datatables.min.js'></script>
                    ...
                    <script src='module/ajuste_condominio/view/local_view_inicio.js' type='text/javascript'></script>
                    <script src='module/ajuste_condominio/view/local_view_tc_condominio.js' type='text/javascript'></script>
                    <script src='module/ajuste_condominio/view/local_view_tc_cta_pagar.js' type='text/javascript'></script>
                    <script src='module/ajuste_condominio/view/local_view_tc_cta_cobrar.js' type='text/javascript'></script>";
